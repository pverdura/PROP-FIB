...
import Codi.Domini.CercaSemblant;
...
public class CercaSemblantTest {
    ...
    public void cercaDoc() throws ArrayDeParaulesBuitException, NombreMassaPetitDocumentsException {
        ...
        Document D5 = new StubDocumentCP5();
        ...
        ArrayList<SimpleEntry<String,String>> resposta = CercaSemblant.cercaDoc(D5,2,DocumentsParaules,Documents);
    ...
    public void cercaDocBuit() throws ArrayDeParaulesBuitException, NombreMassaPetitDocumentsException {
        ...
        CercaSemblant.cercaDoc(D5,2,DocumentsParaules,Documents);
    }
    ...
    public void cercaDocNegatiu() throws ArrayDeParaulesBuitException, NombreMassaPetitDocumentsException {
        ...
        CercaSemblant.cercaDoc(D5,-1,DocumentsParaules,Documents);
    }
}
